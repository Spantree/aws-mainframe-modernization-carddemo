...
| CBACT04C.cbl | batch/InterestCalculator.ts | 1.85 | ✅ Complete |
...
| CBPAUP0C.cbl | batch/AuthorizationProcessor.ts | 1.35 | 🔴 Stub — IMS/MQ specialist required |
...
| CBTRN02C.cbl | batch/TransactionPostingService.ts | 2.0 | ✅ Complete |
| CBTRN03C.cbl | batch/TransactionReportService.ts | 1.6 | ✅ Complete |
...
| COCRDLIC.cbl | online/CardListComplexController.ts | 3.85 | 🔴 Stub — human specialist required |
...
| COTRTLIC.cbl | online/TransactionListComplexController.ts | 3.6 | 🔴 Stub — human specialist required |
| COTRTUPC.cbl | online/TransactionUpdateController.ts | 3.3 | 🔴 Stub — specialist review recommended |
...
|---|---|
| ✅ Complete | 30 |
| ⚠️ Stub / variant covered | 6 |
| 🔴 Stub (human specialist required) | 7 |
| **Total** | **43** |
...
| CVTRA06Y.cpy | entities/DailyTransactionRecord.ts | Daily transaction staging |
| CVTRA01Y.cpy | entities/TransactionCategoryBalance.ts | Transaction category balance |
| CVTRA02Y.cpy | entities/DisclosureGroup.ts | Disclosure group / interest rates |
| CVTRA03Y.cpy | entities/TransactionType.ts | Transaction type |
| CVTRA04Y.cpy | entities/TransactionCategory.ts | Transaction category |
| CSUSR01Y.cpy | entities/UserSecurityRecord.ts | User security |
| CVCUS01Y.cpy | entities/CustomerRecord.ts | Customer record variant |
| CVEXPORT.cpy | entities/ExportRecord.ts | Multi-record export layout |
| COCOM01Y.cpy | dto/CardDemoCommarea.ts | CICS COMMAREA / session DTO |
